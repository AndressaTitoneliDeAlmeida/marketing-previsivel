...
<p>Este planejamento foi gerado com base nas informações informadas e em parâmetros médios de mercado 
compatíveis com o estágio atual da sua empresa.</p>
...
<p>Além da projeção financeira, analisamos o estágio atual informado da empresa para indicar o
 nível de preparação para sustentar o crescimento desejado.</p>
...
function abrirDocumento() {
    ...
    window.open(
        window.location.href = "documento-parceria.html"
    );
